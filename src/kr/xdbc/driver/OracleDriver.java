...
public class OracleDriver extends oracle.jdbc.driver.OracleDriver implements java.sql.Driver {
	public static final String PREFIX = "xdbc:jdbc:oracle:thin:";
	
	static {
		try {
			DriverManager.registerDriver(new kr.xdbc.driver.OracleDriver());
	...
	public java.sql.DriverPropertyInfo[] getPropertyInfo(java.lang.String url, java.util.Properties prop) throws SQLException {
