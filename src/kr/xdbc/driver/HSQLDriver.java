...
public class HSQLDriver extends org.hsqldb.jdbc.JDBCDriver implements java.sql.Driver {
	public static final String PREFIX = "xdbc:jdbc:hsqldb:";
	
	static {
		try {
			DriverManager.registerDriver(new kr.xdbc.driver.HSQLDriver());
