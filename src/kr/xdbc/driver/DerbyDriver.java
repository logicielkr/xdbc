...
public class DerbyDriver extends org.apache.derby.jdbc.AutoloadedDriver implements java.sql.Driver {
	public static final String PREFIX = "xdbc:jdbc:derby:";
	
	static {
		try {
			DriverManager.registerDriver(new kr.xdbc.driver.DerbyDriver());
		} catch (SQLException e) {
			e.printStackTrace();
		}
	}
	public java.sql.Connection connect(String url, Properties prop) throws java.sql.SQLException {
	...
	public java.sql.DriverPropertyInfo[] getPropertyInfo(String url, Properties prop) throws java.sql.SQLException {
