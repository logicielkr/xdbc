...
public class SqliteDriver extends org.sqlite.JDBC implements java.sql.Driver {
	public static final String PREFIX = "xdbc:jdbc:sqlite:";
	
	static {
		try {
			DriverManager.registerDriver(new kr.xdbc.driver.SqliteDriver());
	...
	public java.sql.DriverPropertyInfo[] getPropertyInfo(String url, Properties prop) throws SQLException {
