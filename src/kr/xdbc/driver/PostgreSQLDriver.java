...
public class PostgreSQLDriver extends org.postgresql.Driver implements java.sql.Driver {
	public static final String PREFIX = "xdbc:jdbc:postgresql:";
	
	static {
		try {
			DriverManager.registerDriver(new kr.xdbc.driver.PostgreSQLDriver());
